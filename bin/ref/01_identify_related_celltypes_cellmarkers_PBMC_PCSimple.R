...
# # Revised by Liangying Yin, May 5, 2025
# # Description only keep donor 1,3,4
# # unknown_index <- which(celltypes_all_origi=="Unknown")
# # donor2_index <- which(meta_origi$donor_id=="donor2")
# # invalid_index <- union(unknown_index,donor2_index)
# # all_index <- seq(1,nrow(meta_origi))
# # valid_index <- setdiff(all_index,invalid_index)
...
# scRNA_h5ad <- readH5AD('/mnt/home/yujia/project/2023-04-24-Cell-decomposition/cell_decomposition/dat/09_pbmc_data/01_preprocess_h5ad/5810k_5/5810k_5.h5ad',  reader = c("R"))
# scRNA_h5ad$cell_type <- scRNA_h5ad$celltype_manual

# scRNA_h5ad <- readH5AD('/mnt/home/yujia/project/2023-04-24-Cell-decomposition/cell_decomposition/dat/09_pbmc_data/01_preprocess_h5ad/810K/pbmc810k.h5ad',  reader = c("R"))
...
for(i in 1:length(celltypes)){
    ...
    outputfile <- paste0("/mnt/home/yujia/project/2023-04-24-Cell-decomposition/cell_decomposition/res/01_real_application/00_PBMC_marker/Newman/810K/pbmc810k_no_unknown_major_cellmarkers_PCSimple_",celltype,".RData")
