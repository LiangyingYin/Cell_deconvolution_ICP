...
for(i in 1:length(celltypes)){
    ...
    outputfile <- paste0("/mnt/home/yujia/project/2023-04-24-Cell-decomposition/cell_decomposition/res/01_real_application/00_PBMC_marker/Newman/6810KABC_Batch_PCSimple_ICP/major_cellmarkers_",celltype,".RData")
