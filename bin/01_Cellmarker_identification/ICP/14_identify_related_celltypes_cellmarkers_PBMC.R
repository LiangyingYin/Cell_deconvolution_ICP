...
for(i in 1:length(celltypes)){
    ...
    outputfile <- paste0("/mnt/home/yinly/projects/Cell_deconvolution/res/06_Benchmark/01_Cellmarker_identification/PBMC/pbmc5810k_5_no_unknow_major_cellmarkers_0.2_",celltype,".RData")
