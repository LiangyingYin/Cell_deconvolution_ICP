...
scRNA <- fread("/mnt/home/yinly/projects/Cell_deconvolution/dat/01_Cellmarker_identification/PBMC/PBMC_scRNA_exp_5810k_6.csv") # dim(scRNA): 222077  21487
scRNA <- scRNA[,-1] # the 1st column is index
meta_origi <- fread("/mnt/home/yinly/projects/Cell_deconvolution/dat/01_Cellmarker_identification/PBMC/PBMC_scRNA_meta_5810k_6.csv")
...
for(i in 1:length(celltypes)){
    ...
    outputfile <- paste0("/mnt/home/yinly/projects/Cell_deconvolution/res/06_Benchmark/01_Cellmarker_identification/PBMC/pbmc5810k_5_no_unknown_nodonor2_cellmarkers_0.2_",celltype,".RData")
