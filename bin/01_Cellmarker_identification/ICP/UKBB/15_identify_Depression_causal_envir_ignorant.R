...
for (celltype in celltypes){
    ...
    cat("There are",sum(label_binary),"depression patients in the dataset. \n")
    ...
    outputfile <- paste0("/mnt/home/yinly/projects/Cell_deconvolution/res/06_Benchmark/01_Cellmarker_identification/UKBB_gene_set/Depression/Depression_causal_",celltype,"_envir_ignore.RData")
