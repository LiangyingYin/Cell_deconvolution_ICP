...
for (celltype in celltypes){
    ...
    outputfile <- paste0("/mnt/home/yinly/projects/Cell_deconvolution/res/06_Benchmark/01_Cellmarker_identification/UKBB_gene_set/ObesitySAT/ObesitySAT_causal_",celltype,"_envir_ignore.RData")
