...
for (celltype in celltypes){
    ...
    # split cell-type-specific scRNASeq into 2 subsets based on environment variable race
    ...
    cat("There are",sum(label_fir_binary),"obesity patients in the 1st dataset. \n")
    ...
    cat("There are",sum(label_sec_binary),"obesity patients in the 2nd dataset. \n")
    ...
    outputfile <- paste0("/mnt/home/yinly/projects/Cell_deconvolution/res/06_Benchmark/01_Cellmarker_identification/UKBB_gene_set/ObesitySAT/ObesitySAT_causal_",celltype,".RData")
