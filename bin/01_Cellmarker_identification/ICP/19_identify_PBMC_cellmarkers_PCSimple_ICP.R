...
for(i in 1:length(celltypes)){
    ...
    dtrain_fir_model <- xgb.train(data = dtrain_fir, max.depth = 3, eta = 0.8, nthread = 10, nrounds = 10, objective = "binary:logistic")
    ...
    outputfile <- paste0("/mnt/home/yinly/projects/Cell_deconvolution/res/06_Benchmark/01_Cellmarker_identification/PBMC/6810KABC_PCSimple_ICP_Tune/6810KABC_cellmarkers_",celltype,".RData")
