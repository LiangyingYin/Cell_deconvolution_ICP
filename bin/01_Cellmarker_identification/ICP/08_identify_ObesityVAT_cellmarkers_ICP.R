...
for(i in 1:length(celltypes)){
    ...
    outputfile <- paste0("/mnt/home/yinly/projects/Cell_deconvolution/res/06_Benchmark/01_Cellmarker_identification/ObesityVAT/ObesityVAT_cellmarkers_",celltype,".RData")
