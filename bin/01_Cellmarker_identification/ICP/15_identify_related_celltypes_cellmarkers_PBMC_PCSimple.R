...
for(i in 1:length(celltypes)){
    ...
    outputfile <- paste0("/mnt/home/yinly/projects/Cell_deconvolution/res/06_Benchmark/01_Cellmarker_identification/PBMC/Bulk_matched/5810K_5_PCSimple/Monaco/pbmc5810k_5_no_unknown_major_cellmarkers_PCSimple_",celltype,".RData")
