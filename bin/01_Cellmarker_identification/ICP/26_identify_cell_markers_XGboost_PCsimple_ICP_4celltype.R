...
load("/mnt/home/yujia/project/2023-04-24-Cell-decomposition/cell_decomposition/res/14_addon_simulation/4celltypes/toydata_batch_20genes_16.RData")
normal <- NULL
...
patient_batch <- NULL
# We only take the first 7 patients and controls for analysis
for(i in 1:7){
...
fwrite(as.data.frame(scRNA_all),"/mnt/home/yinly/projects/Cell_deconvolution/dat/01_Cellmarker_identification/Simulation/4Celltypes.txt",sep="\t")
rm(list=ls())
...
scRNA_all <- fread("/mnt/home/yinly/projects/Cell_deconvolution/dat/01_Cellmarker_identification/Simulation/4Celltypes.txt")
...
for(i in 1:length(celltypes)){
    ...
    # colnames(dfnew) <- gsub("HLA.","HLA-",colnames(dfnew))
    ...
    outputfile <- paste0("/mnt/home/yinly/projects/Cell_deconvolution/res/06_Benchmark/01_Cellmarker_identification/Simulation/4Celltypes/4Celltypes_cellmarkers_",celltype,".RData")
