...
for (c in 1:15){
    ...
    outputfile <- paste0("/mnt/home/yinly/projects/Cell_deconvolution/res/06_Benchmark/01_Cellmarker_identification/ObesityVAT/ObesityVAT_causal_",celltype,"_envir_ignore.RData")
