...
UKBB <- fread("/exeh_3/yinly/Cell_deconvolution/02_Cell_deconvolution/res/res_imputed_genes/breast_cancer_genes.csv",header=TRUE)
UKBB_genes <- as.vector(unlist(UKBB[,3]))
...
for(i in 1:length(celltypes)){
    ...
    outputfile <- paste0("/exeh_3/yinly/Cell_deconvolution/01_Cellmarker_identification/res/res_Breast_normal_UKBB/BRCA_cellmarkers_",celltype,".RData")
