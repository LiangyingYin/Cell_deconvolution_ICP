...
for(i in 1:length(celltypes)){
    ...
    outputfile <- paste0("/exeh_3/yinly/Cell_deconvolution/01_Cellmarker_identification/res/res_Breast_normal_SPred_final_status_ignorant/BRCA_cellmarkers_",celltype,".RData")
